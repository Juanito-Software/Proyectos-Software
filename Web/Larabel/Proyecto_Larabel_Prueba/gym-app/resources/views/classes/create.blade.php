...
@section('content')
@php
    $prefix = auth()->user()->role === 'admin' ? 'admin' : 'coach';
@endphp
    ...
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">
                    Agrega una nueva clase al programa del gimnasio
                </p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                ...
                <form action="{{ route($prefix.'.classes.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea id="desc" name="desc" rows="3"
                                  class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:focus:border-indigo-400 dark:focus:ring-indigo-400"
                                  placeholder="Describe brevemente la clase...">{{ old('desc') }}</textarea>
                    </div>
