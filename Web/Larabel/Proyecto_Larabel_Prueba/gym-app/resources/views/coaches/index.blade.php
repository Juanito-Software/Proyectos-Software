        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-bold">Entrenadores</h1>
                        <p class="text-gray-600 dark:text-gray-400 mt-1">
                            Gestiona todos los entrenadores del gimnasio
                        </p>
                    </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-2 mb-4">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-gray-900 dark:text-gray-100">{{ $coach->sport }}</span>
                                </div>
                                @endif
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-gray-900 dark:text-gray-100">{{ $coach->phone_number }}</span>
                                </div>
                                @endif
                            </div>
                            ...
                            <div class="flex space-x-2">
                                ...
                                <form action="{{ route('coaches.destroy', $coach->id) }}" method="POST" class="flex-1">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" 
