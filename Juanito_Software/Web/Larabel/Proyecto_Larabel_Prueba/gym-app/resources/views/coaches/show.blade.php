                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <span class="text-sm text-gray-900 dark:text-gray-100">{{ $coach->name }}</span>
                        </div>
                        
                        <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                            <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Email:</span>
                            <span class="text-sm text-gray-900 dark:text-gray-100">{{ $coach->email }}</span>
                        </div>
                        
                        <div class="flex justify-between items-center py-2">
                            <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Teléfono:</span>
                            <span class="text-sm text-gray-900 dark:text-gray-100">
                                {{ $coach->phone_number ?? 'No proporcionado' }}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <span class="text-sm text-gray-900 dark:text-gray-100">#{{ $coach->id }}</span>
                        </div>
                        
                        <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                            <span class="text-sm font-medium text-gray-500 dark:text-gray-400">🏃‍♂️ Especialidad:</span>
                            <span class="text-sm text-gray-900 dark:text-gray-100">
                                {{ $coach->sport ?? 'No especificada' }}
                            </span>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <span class="text-sm text-gray-900 dark:text-gray-100">
                                {{ $coach->created_at->format('d/m/Y H:i') }}
                            </span>
                        </div>
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                            <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Clases asignadas:</span>
                            <span class="text-sm text-gray-900 dark:text-gray-100">
                                {{ $coach->classes->count() }} clase(s)
                            </span>
                        </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mt-6">
            <div class="p-6">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <form action="{{ route('admin.coaches.destroy', $coach->id) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit" 
