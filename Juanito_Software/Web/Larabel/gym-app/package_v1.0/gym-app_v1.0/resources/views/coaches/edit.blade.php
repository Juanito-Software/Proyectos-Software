    ...
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <h1 class="text-2xl font-bold">Editar Entrenador</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">
                    Modifica la información del entrenador: {{ $coach->name }}
                </p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                ...
                <form action="{{ route('admin.coaches.update', $coach->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input id="name" name="name" type="text" 
                               ...
                               value="{{ old('name', $coach->name) }}" required autofocus />
                    </div>
                    ...
                    <div>
                        ...
                        <input id="phone_number" name="phone_number" type="tel" 
                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:focus:border-indigo-400 dark:focus:ring-indigo-400" 
                               value="{{ old('phone_number', $coach->phone_number) }}" 
