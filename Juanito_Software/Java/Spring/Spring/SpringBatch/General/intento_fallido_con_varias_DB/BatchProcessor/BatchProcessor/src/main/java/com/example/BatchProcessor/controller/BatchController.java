...
public class BatchController {
    ...
    public BatchController(JobLauncher jobLauncher, ApplicationContext context, @Qualifier("primaryTransactionManager") JpaTransactionManager jpaTransactionManager, @Qualifier("jobRepository") JobRepository jobRepository, JobCompletionListener jobCompletionListener) {
